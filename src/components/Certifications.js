...
const Certifications = () => {
  ...
  return (
    <section
      id="certifications"
      ref={sectionRef}
      className={`py-20 bg-gray-800 transition-all duration-1000 ease-out ${
    ...
    >
      <div className="container mx-auto text-center">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          <div className="group bg-gray-700 p-6 rounded-lg shadow-lg transition-transform transform hover:scale-105 hover:bg-gray-600 hover:shadow-2xl">
